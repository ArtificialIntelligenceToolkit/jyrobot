...
def test_AvoidObstacles():
    world = jyrobot.World(width=200, height=200, scale=5.0)
...
def test_Coverage():
    world = jyrobot.World(width=200, height=200, scale=5.0, seed=12345)
    robot = jyrobot.Scribbler(x=100, y=100, direction=87, max_trace_length=60)
    robot.add_device(
        jyrobot.RangeSensor(
...
def test_SeekLight():
    ...
    world = jyrobot.load_world(WORLD)
